/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */
 ...
 int main (int argc, char *argv[])
 {
   ...
   bottleneckLink.SetDeviceAttribute ("DataRate", StringValue (bandwidth));  // defaults to 10Mbps
   bottleneckLink.SetChannelAttribute ("Delay", StringValue (delay));        // default to 5ms
