...
//	
	...
	// Set On/Off Attributes
		Ptr<ExponentialRandomVariable> on_erv = CreateObject<ExponentialRandomVariable> ();
		Ptr<ExponentialRandomVariable> off_erv = CreateObject<ExponentialRandomVariable> ();
	        ...
	        oo.SetAttribute("OnTime",PointerValue (on_erv));  
	        oo.SetAttribute("OffTime",PointerValue (off_erv)); 
