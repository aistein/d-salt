...
namespace ns3 {
	...
	PbsPacketFilter::MakePrioLimits (void)
	{
		...
		switch (m_profile) {
			case 1: // W1 (alpha = 10)
				if (m_nonBlind) {
					limits = {5.10708e-41, 3.12373e-41, 2.67044e-41, 2.19076e-41, 1.87042e-41, 1.59852e-41, 1.37976e-41, 1.18287e-41};
			...
			case 2: // W2 (alpha = 10)
				if (m_nonBlind) {
					limits = {1.87761e-39, 2.22075e-40, 6.0904e-41, 2.93441e-41, 2.17523e-41, 1.5628e-44, 1.5627e-44, 1.56258e-44};
